...
const mockPatterns: PatternInfo[] = [
  {
    id: 'ii-V-I-major',
    name: 'ii-V-I Major',
    description: 'Классический ii-V-I',
    defaultBars: 4,
    variableLength: true,
  },
];
...
describe('GeneratorModal', () => {
  ...
  it('shows pattern list', () => {
    renderWithProviders(<GeneratorModal open onApply={vi.fn()} onClose={vi.fn()} />);
  ...
  it('calls onClose when cancel clicked', () => {
    const onClose = vi.fn();
    renderWithProviders(<GeneratorModal open onApply={vi.fn()} onClose={onClose} />);
