...
export default defineConfig({
  ...
  resolve: {
    ...
    alias: {
      ...
      '@jazz/plugin-upright-piano': r(
        '../../packages/plugins/instruments/upright-piano/src/index.ts',
      ),
      ...
      '@jazz/plugin-theory-arpeggios': r(
        '../../packages/plugins/theory/theory-arpeggios/src/index.ts',
      ),
      ...
      '@jazz/plugin-theory-voicings': r(
        '../../packages/plugins/theory/theory-voicings/src/index.ts',
      ),
