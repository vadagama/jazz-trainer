...
const SWING_PROFILE: StyleProfile = {
  ...
  instrumentDefaults: {
    ...
    'upright-piano': { ...OFF },
    rhodes: { enabled: false, volume: 0.55, mode: 'subtle-offbeats', voicing: 'rootless3' },
...
const BOSSA_PROFILE: StyleProfile = {
  ...
  instrumentDefaults: {
    ...
    'upright-piano': { ...OFF },
    rhodes: { enabled: false, volume: 0.5, mode: 'ambient-swells', voicing: 'shell2' },
...
const FUNK_PROFILE: StyleProfile = {
  ...
  instrumentDefaults: {
    ...
    'upright-piano': { ...OFF },
    rhodes: { enabled: false, volume: 0.6, mode: 'stab-accents', voicing: 'rootless4' },
    guitar: { ...OFF },
...
const LATIN_PROFILE: StyleProfile = {
  ...
  instrumentDefaults: {
    ...
    'upright-piano': { ...OFF },
    rhodes: { enabled: false, volume: 0.55, mode: 'high-comping', voicing: 'rootless3' },
    guitar: { ...OFF },
    'electric-guitar': { ...OFF },
...
const BALLAD_PROFILE: StyleProfile = {
  ...
  instrumentDefaults: {
    ...
    'upright-piano': { ...OFF },
    rhodes: { enabled: false, volume: 0.5, mode: 'pads', voicing: 'shell2' },
    guitar: { ...OFF },
    'electric-guitar': { ...OFF },
