...
const BASE_MOLECULES: MolDraft[] = [
  ...
  },
  {
    ...
    bars: 2,
    atoms: [atom('chord', B1, 0.3, PPQ * 4), atom('chord', B1 + PPQ * 4, 0.4, PPQ * 4)],
    category: 'texture',
  ...
  },
  {
    ...
    bars: 1,
    atoms: [atom('shell', B2 + _8off, 0.35, _8), atom('shell', B4 + _8off, 0.32, _8)],
    category: 'groove',
  ...
  },
  {
    ...
    bars: 1,
    atoms: [atom('chord', B2, 0.42, PPQ / 3), atom('chord', B4, 0.4, PPQ / 3)],
    category: 'accent',
