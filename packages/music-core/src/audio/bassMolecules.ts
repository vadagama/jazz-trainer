...
const ELECTRIC_MOLECULE_DRAFTS: Omit<BassMolecule, 'style'>[] = [
  // ── Funk: syncopated — muted (ghost) notes are the heart of the groove ───
  {
    ...
    bars: 1,
    atoms: [
      atom('regular', B1, 0.45, Q),
      atom('muted', B1and, 0.18, _8),
      atom('regular', B3, 0.41, Q),
      atom('muted', B4and, 0.20, _8),
    ],
    category: 'groove',
  ...
  },
  {
    ...
    bars: 1,
    atoms: [
      atom('regular', B1, 0.46, Q),
      atom('muted', B1and, 0.17, _8),
      atom('muted', B2and, 0.20, _8),
      atom('regular', B3, 0.41, Q),
      atom('stac', B3and, 0.29, _8),
      atom('muted', B4e, 0.15, _16),
      atom('regular', B4and, 0.39, _8),
    ],
    category: 'groove',
  ...
  },
  {
    ...
    bars: 1,
    atoms: [
      atom('regular', B1, 0.46, _8),
      atom('muted', B1and, 0.15, _16),
      atom('muted', B2e, 0.17, _16),
      atom('stac', B2and, 0.31, _8),
      atom('muted', B3, 0.15, _16),
      atom('regular', B3and, 0.39, _8),
      atom('muted', B3a, 0.14, _32),
      atom('muted', B4e, 0.15, _16),
      atom('stac', B4and, 0.29, _8),
    ],
    category: 'groove',
  ...
  },
  {
    ...
    bars: 1,
    atoms: [
      atom('regular', B1, 0.45, _8),
      atom('stac', B1and, 0.32, _8),
      atom('muted', B2and, 0.17, _16),
      atom('regular', B3, 0.41, Q),
      atom('stac', B4and, 0.31, _8),
    ],
    category: 'groove',
  ...
  },
  {
    ...
    bars: 1,
    atoms: [
      atom('regular', B1, 0.43, Q),
      atom('regular', B2, 0.38, Q),
      atom('regular', B3, 0.41, Q),
      atom('rel', B4, 0.35, Q),
    ],
    category: 'fill',
  ...
  },
  {
    ...
    atoms: [
      atom('regular', B1, 0.45, Q),
      atom('muted', B1and, 0.17, _8),
      atom('muted', B2and, 0.18, _8),
      atom('regular', B3, 0.41, Q),
      atom('muted', B4and, 0.18, _8),
      atom('stac', B1 + PPQ * 4, 0.32, _8),
      atom('muted', B1and + PPQ * 4, 0.15, _16),
      atom('stac', B2 + PPQ * 4, 0.31, _8),
      atom('regular', B3 + PPQ * 4, 0.42, Q),
      atom('rel', B4 + PPQ * 4, 0.35, Q),
    ],
    category: 'groove',
  ...
  // ── Funk: 16th-note driven (бодрые) ──────────────────────────────────────
  {
    ...
    bars: 1,
    atoms: [
      atom('regular', B1, 0.45, _16),
      atom('muted', B1e, 0.15, _16),
      atom('muted', B1and, 0.15, _16),
      atom('muted', B1a, 0.14, _16),
      atom('regular', B2, 0.39, _16),
      atom('muted', B2e, 0.14, _16),
      atom('stac', B2and, 0.29, _16),
      atom('muted', B2a, 0.14, _16),
      atom('regular', B3, 0.41, _16),
      atom('muted', B3e, 0.14, _16),
      atom('muted', B3and, 0.15, _16),
      atom('muted', B3a, 0.14, _16),
      atom('regular', B4, 0.38, _16),
      atom('muted', B4e, 0.14, _16),
      atom('stac', B4and, 0.28, _16),
      atom('muted', B4a, 0.14, _16),
    ],
    category: 'groove',
  ...
  },
  {
    ...
    atoms: [
      atom('regular', B1, 0.46, _8),
      atom('stac', B1and, 0.31, _8),
      atom('muted', B1a, 0.14, _16),
      atom('regular', B2, 0.41, _8),
      atom('stac', B2and, 0.29, _8),
      atom('muted', B2a, 0.14, _16),
      atom('regular', B3, 0.42, _8),
      atom('stac', B3and, 0.31, _8),
      atom('muted', B3a, 0.14, _16),
      atom('regular', B4, 0.39, _8),
      atom('stac', B4and, 0.29, _8),
      atom('rel', B4a, 0.34, _16),
    ],
    category: 'groove',
  ...
  },
  {
    ...
    atoms: [
      ...
      atom('regular', B3, 0.41, Q),
      atom('muted', B4and, 0.18, _8),
      atom('regular', B1 + PPQ * 4, 0.45, _16),
      atom('muted', B1e + PPQ * 4, 0.15, _16),
      atom('stac', B1and + PPQ * 4, 0.29, _16),
      atom('muted', B1a + PPQ * 4, 0.14, _16),
      atom('regular', B2 + PPQ * 4, 0.41, _16),
      atom('muted', B2e + PPQ * 4, 0.14, _16),
      atom('stac', B2and + PPQ * 4, 0.28, _16),
      atom('muted', B2a + PPQ * 4, 0.14, _16),
      atom('regular', B3 + PPQ * 4, 0.42, _8),
      atom('stac', B3and + PPQ * 4, 0.29, _8),
      atom('regular', B4 + PPQ * 4, 0.41, _8),
      atom('rel', B4and + PPQ * 4, 0.34, _8),
    ],
    category: 'groove',
  ...
  // ── Latin: montuno (tumbão) ──────────────────────────────────────────────
  {
    ...
    bars: 1,
    atoms: [
      atom('regular', B1, 0.43, Q + _8),
      atom('stac', B2and, 0.34, _8),
      atom('regular', B3, 0.39, Q),
    ],
    category: 'groove',
  ...
  },
  {
    ...
    atoms: [
      atom('regular', B1, 0.43, Q + _8),
      atom('stac', B2and, 0.34, _8),
      atom('regular', B3, 0.38, Q),
      atom('stac', B4, 0.31, _8),
    ],
    category: 'groove',
  ...
  },
  {
    ...
    atoms: [
      atom('regular', B1, 0.43, Q),
      atom('stac', B2and, 0.32, _8),
      atom('regular', B3, 0.39, Q),
      atom('stac', B3and, 0.28, _8),
      atom('stac', B4and, 0.31, _8),
    ],
    category: 'groove',
  ...
  },
  {
    ...
    atoms: [
      ...
      atom('stac', B2and, 0.32, _8),
      atom('regular', B3, 0.39, Q),
      atom('regular', B1 + PPQ * 4, 0.43, Q),
      atom('stac', B2 + PPQ * 4, 0.34, _8),
      atom('regular', B2and + PPQ * 4, 0.38, _8),
      atom('stac', B4 + PPQ * 4, 0.31, _8),
    ],
    category: 'groove',
