...
export const GENERATED_PIANO_ORGANISMS: Record<string, unknown> = {
    ...
    defaultForm: [
      {
        label: 'Verse',
        type: 'verseA',
        cellPool: ['piano-swing-sparse'],
        repeats: 1,
      },
      {
        label: 'Chorus',
        type: 'chorus',
        cellPool: ['piano-swing-medium'],
        repeats: 1,
      },
      {
        label: 'Bridge',
        type: 'bridge',
        cellPool: ['piano-basie-light-swing'],
        repeats: 1,
      },
      {
        label: 'Chorus',
  ...
  'piano-beginner-form': {
    ...
    sectionMap: {
      ...
      verseB: ['piano-beginner-safe-swing'],
    ...
    defaultForm: [
      {
        label: 'Verse',
        type: 'verseA',
        cellPool: ['piano-beginner-safe-swing'],
        repeats: 1,
      },
      {
        label: 'Chorus',
    ...
    defaultForm: [
      {
        label: 'Verse',
        type: 'verseA',
        cellPool: ['piano-bossa-sparse'],
        repeats: 1,
      },
      {
        label: 'Chorus',
        type: 'chorus',
        cellPool: ['piano-bossa-medium'],
        repeats: 1,
      },
      {
        label: 'Bridge',
    ...
    defaultForm: [
      {
        label: 'Verse',
        type: 'verseA',
        cellPool: ['piano-funk-sparse'],
        repeats: 1,
      },
      {
        label: 'Chorus',
        type: 'chorus',
        cellPool: ['piano-funk-medium'],
        repeats: 1,
      },
      {
        label: 'Bridge',
    ...
    defaultForm: [
      {
        label: 'Verse',
        type: 'verseA',
        cellPool: ['piano-latin-sparse'],
        repeats: 1,
      },
      {
        label: 'Chorus',
        type: 'chorus',
        cellPool: ['piano-latin-montuno'],
        repeats: 1,
      },
      {
        label: 'Bridge',
    ...
    defaultForm: [
      {
        label: 'Verse',
        type: 'verseA',
        cellPool: ['piano-ballad-sparse'],
        repeats: 1,
      },
      {
        label: 'Chorus',
        type: 'chorus',
        cellPool: ['piano-ballad-medium'],
        repeats: 1,
      },
      {
        label: 'Bridge',
    ...
    defaultForm: [
      {
        label: 'Verse',
        type: 'verseA',
        cellPool: ['piano-ballad-extended'],
        repeats: 1,
      },
      {
        label: 'Chorus',
