...
describe('Bass Constructor plugin — contract', () => {
  ...
  it('nav item lives in the admin section and is permission-gated', () => {
    ...
    expect(nav?.to).toBe('/admin/constructor/bass');
