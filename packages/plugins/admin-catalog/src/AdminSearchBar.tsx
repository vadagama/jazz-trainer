...
export type AdminSort = 'newest' | 'name_asc' | 'updated';

interface Props {
  value: string;
  onChange: (v: string) => void;
  sort: AdminSort;
  onSortChange: (v: AdminSort) => void;
}

export function AdminSearchBar({ value, onChange, sort, onSortChange }: Props) {
  return (
    <div className="flex flex-col gap-2 sm:flex-row">
      ...
      <Select value={sort} onValueChange={(v) => onSortChange(v as AdminSort)}>
