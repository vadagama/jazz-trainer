...
describe('admin-assets — contract', () => {
  ...
  it('navItems have required fields', () => {
    ...
    expect(plugin.contributes.navItems![0]!.requires).toBe('assets:read');
  });
});
