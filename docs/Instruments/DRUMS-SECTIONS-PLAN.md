...
### T-018. Документация: обновить docs/Instruments/DRUMS.md

- **Родительская функция:** Сопроводительная документация
- **Приоритет:** P2
- **Сложность:** XS (<1d)
- **Слой:** docs
- **Модуль:** `docs/Instruments/DRUMS.md`
- **Описание:**
...
_План создан на основе DRUMS-SECTIONS-VISION.md v1.0. Статусы обновляются по мере выполнения._
