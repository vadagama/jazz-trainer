...
> аранжировки Amazilia. Покрывает паттерн `Instrument`-класса, манифест,
...
## 1. Что такое мелодический инструмент в Amazilia
...
_См. также: `docs/ARCHITECTURE_BASE.md` (архитектура), `docs/Instruments/PIANO.md` (фортепиано), `docs/Instruments/INSTRUMENT-PLUGIN.md` (целевая архитектура плагинов), `docs/Instruments/RHYTHMIC-PLUGIN.md` (ритмические инструменты)_
