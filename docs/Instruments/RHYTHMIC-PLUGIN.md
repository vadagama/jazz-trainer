...
> аранжировки Amazilia: барабанные киты, перкуссия и другие ритмические звуки.
...
## 1. Что такое ритмический инструмент в Amazilia
...
_См. также: `docs/ARCHITECTURE_BASE.md` (архитектура), `docs/Instruments/DRUMS.md` (барабаны), `docs/Instruments/DRUMS-PATTERNS.md` (атомы/молекулы/клетки), `docs/Instruments/INSTRUMENT-PLUGIN.md` (целевая архитектура плагинов), `docs/Instruments/MELODIC-PLUGIN.md` (мелодические инструменты)_
