...
Grand Piano — **основной гармонический инструмент** в аранжировке Amazilia. В отличие от Rhodes, который выполняет роль комплементарного слоя, Grand Piano берёт на себя ведущую гармоническую партию:
...
_См. также: `docs/Instruments/RHODES.md` (комплементарный слой), `docs/Instruments/BASS.md` (бас),
