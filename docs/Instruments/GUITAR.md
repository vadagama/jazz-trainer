...
Гитара в Amazilia — **ритмический и гармонический инструмент** среднего регистра. Представлена двумя вариантами сэмплов, использующими один класс `GuitarInstrument`:
...
_См. также: `docs/Instruments/PIANO.md` (основная гармония), `docs/Instruments/BASS.md` (бас)_
