...
_См. также: `docs/Instruments/DRUMS-VISION.md` (видение), `docs/Instruments/DRUMS-PATTERNS.md` (паттерны), `docs/Instruments/PERCUSSION.md` (перкуссия), `docs/Instruments/BASS.md` (бас)_
