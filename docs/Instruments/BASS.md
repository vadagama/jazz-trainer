...
> **Спецификация:** `docs/Instruments/MELODIC-PLUGIN.md`

## 1. Роль баса

Бас — фундамент ритм-секции. В Amazilia он выполняет три функции:
...
_См. также: `docs/Instruments/MELODIC-PLUGIN.md`, `docs/Instruments/PIANO.md`, `docs/Instruments/RHODES.md`, `docs/Instruments/DRUMS.md`_
