...
```ts
type Style = 'swing' | 'bossa' | 'funk' | 'latin' | 'ballad' | 'blues' | 'soul';
```

> `'blues'` и `'soul'` — 🟡 roadmap, описаны в VISION-документах ([BLUES-VISION.md](BLUES-VISION.md), [SOUL-VISION.md](SOUL-VISION.md)), но ещё не добавлены в `constants.ts`/`styleProfile.ts`.
...
| `blues`  | Blues           | 110        | 0.67 (shuffle) | 4/4      | Shuffle-пульсация, доминантовые voicing, «dirty» тон |
| `soul`   | Soul / Neo Soul | 80         | 0.5 (straight) | 4/4      | Медленный качающий грув, Rhodes в центре, ghost-ноты |

### 1.1. Ростеры инструментов по стилям

Каждый стиль определяет, какие инструменты уместны (`required` / `optional`), а какие скрыты (`hidden`).
...
| Optional  | Rhodes, Trumpet (muted), Vibraphone, Clarinet                                                           |
...
| --------- | ------------------------------------------------------------------------------------------------------- |
| Required  | Drums (Swirly), Upright Bass, Piano                                                                     |
| Optional  | Guitar (nylon), Rhodes, Flute, Percussion                                                               |
...
| Optional  | Rhodes, Electric Guitar, Organ, Trumpet (muted), Percussion                                  |
...
| Optional  | Trumpet (muted), Flute, Vibraphone, Rhodes                                                     |
...
| --------- | --------------------------------------------------------------------------------------------------------------------------- |
| Required  | Drums (Swirly), Upright Bass, Piano                                                                                         |
| Optional  | Rhodes, Flute, Vibraphone                                                                                                   |
| Hidden    | Modern Kit, Electric Bass, Upright Piano, Nylon/Steel Guitar, Electric Guitar, Organ, Clarinet, Percussion, Trumpet (muted) |

#### Blues

> 🟡 roadmap — целевой ростер из [BLUES-VISION.md](BLUES-VISION.md).

| Категория | Инструменты                                                                                             |
| --------- | ------------------------------------------------------------------------------------------------------- |
| Required  | Drums (jazz-kit, shuffle), Upright Bass, Piano                                                          |
| Optional  | Electric Guitar, Organ, Vibraphone, Trumpet (muted), Clarinet                                           |
| Hidden    | Modern Kit (funk-drum-kit), Electric Bass, Upright Piano, Nylon/Steel Guitar, Rhodes, Percussion, Flute |

#### Soul

> 🟡 roadmap — целевой ростер из [SOUL-VISION.md](SOUL-VISION.md).
> Уникальный стиль: Rhodes — **ядро** (ведущий гармонический), Piano — надстройка.

| Категория | Инструменты                                                                             |
| --------- | --------------------------------------------------------------------------------------- |
| Required  | Modern Kit (funk-drum-kit, soul-режим), Electric Bass, Rhodes                           |
| Optional  | Piano, Organ, Percussion (shaker), Vibraphone, Electric Guitar, Trumpet (muted)         |
| Hidden    | Drums (jazz-drum-kit), Upright Bass, Upright Piano, Nylon/Steel Guitar, Clarinet, Flute |
...
> 🟡 roadmap — целевые ансамбли из [BLUES-VISION.md](BLUES-VISION.md).

| Ансамбль    | Инструменты                                                                                      |
| ----------- | ------------------------------------------------------------------------------------------------ |
| **Duet**    | Piano + Upright Bass                                                                             |
| **Trio**    | Drums + Piano + Upright Bass                                                                     |
| **Quartet** | Drums + Piano + Upright Bass + Organ                                                             |
| **Quintet** | Drums + Piano + Upright Bass + Organ + Electric Guitar                                           |
| **Full**    | Drums + Upright Bass + Piano + Organ + Electric Guitar + Trumpet (muted) + Vibraphone + Clarinet |

### 5.7. Soul-ансамбли

> 🟡 roadmap — целевые ансамбли из [SOUL-VISION.md](SOUL-VISION.md).
> Rhodes — ядро; Piano — надстройка (роли инвертированы относительно всех остальных стилей).

| Ансамбль    | Инструменты                                                                                                |
| ----------- | ---------------------------------------------------------------------------------------------------------- |
| **Duet**    | Rhodes + Electric Bass                                                                                     |
| **Trio**    | Drums (funk-kit) + Electric Bass + Rhodes                                                                  |
| **Quartet** | Drums (funk-kit) + Electric Bass + Rhodes + Percussion (shaker)                                            |
| **Quintet** | Drums (funk-kit) + Electric Bass + Rhodes + Percussion + Piano                                             |
| **Full**    | Drums (funk-kit) + Electric Bass + Rhodes + Percussion + Piano + Organ + Electric Guitar + Trumpet (muted) |
...
> Столбцы `blues` и `soul` — 🟡 roadmap, значения из [BLUES-VISION.md](BLUES-VISION.md) и [SOUL-VISION.md](SOUL-VISION.md).

| Инструмент          | Swing                                 | Bossa                             | Funk                               | Latin                              | Ballad                             | Blues                              | Soul                                  |
| ------------------- | ------------------------------------- | --------------------------------- | ---------------------------------- | ---------------------------------- | ---------------------------------- | ---------------------------------- | ------------------------------------- |
| **Drums**           | on, 0.70, swing                       | on, 0.60, bossa                   | OFF                                | on, 0.70, latin                    | on, 0.50, ballad                   | on, 0.70, shuffle                  | OFF                                   |
...
| **Guitar**          | off, 0.65, freddie-green, steel       | off, 0.70, bossa-comping, nylon   | OFF                                | OFF                                | OFF                                | OFF                                | OFF                                   |
...
| [SWING-VISION.md](Genres/SWING-VISION.md)                                   | Музыкальное видение стиля Swing                 |
| [BOSSA-VISION.md](Genres/BOSSA-VISION.md)                                   | Музыкальное видение стиля Bossa Nova            |
| [FUNK-VISION.md](Genres/FUNK-VISION.md)                                     | Музыкальное видение стиля Funk                  |
| [LATIN-VISION.md](Genres/LATIN-VISION.md)                                   | Музыкальное видение стиля Latin                 |
| [BALLAD-VISION.md](Genres/BALLAD-VISION.md)                                 | Музыкальное видение стиля Ballad                |
| [BLUES-VISION.md](Genres/BLUES-VISION.md)                                   | Музыкальное видение стиля Blues (🟡 roadmap)    |
| [SOUL-VISION.md](Genres/SOUL-VISION.md)                                     | Музыкальное видение стиля Soul (🟡 roadmap)     |

---

_Последнее обновление: 2026-07-25. Актуально для состояния кодовой базы на эту дату._
