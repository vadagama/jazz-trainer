...
| Код | Название | Описание |
| --- | --- | --- |
| `system:settings:read` | Чтение настроек | Просмотр настроек по умолчанию на `/admin/defaults` |
| `system:settings:write` | Редактирование настроек | Изменение заводских настроек по умолчанию (`/admin/defaults`): глобальные дефолты для новых и гостевых пользователей |
