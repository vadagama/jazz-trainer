...
#### T-031. Создать `docs/Instruments/PIANO.md`

- **Родительская функция:** 4.4 (Документация)
- **Приоритет:** P1
- **Сложность:** S
- **Слой:** docs
- **Плагин / Модуль:** `docs/Instruments/PIANO.md` (новый)
- **Описание:**
...
#### T-032. Обновить `docs/Instruments/RHODES.md`

- **Родительская функция:** 4.4 (Документация)
- **Приоритет:** P1
- **Сложность:** S
- **Слой:** docs
- **Плагин / Модуль:** `docs/Instruments/RHODES.md`
- **Описание:**
