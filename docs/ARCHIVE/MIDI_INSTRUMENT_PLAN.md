...
- **Описание:** Документ, описывающий MIDI-подсистему Amazilia: подключение устройств, выбор тембра, соло-инструменты (синтез vs сэмплы), ducking, запись, JamEval, пресеты сцены, MIDI-выход. Для пользователей и разработчиков.
