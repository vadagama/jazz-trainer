...
Добавить в админку Amazilia раздел управления **настройками инструментов по умолчанию** — глобальные значения, которые становятся отправной точкой для двух категорий пользователей:
...
- Для гостевых пользователей это единственный способ получить _управляемые_ (а не жёстко закодированные) настройки.
...
_Документ создан 2026-07-25 аналитиком на основе запроса пользователя. Для реализации передать агенту `software-engineer`._
