...
**На основе:** `docs/ARCHIVE/ARANGEMENT_VISION.md`
**Дата:** 2026-07-01
...
- **Описание:**
  - Определить тип `EnsemblePreset`:
    ...
    interface EnsemblePreset {
      ...
      instrumentSettings: Record<
        InstrumentId,
        { enabled: boolean; volume?: number; pattern?: string; voicing?: string }
      >;
    }
    ```
...
- **Описание:**
  - Обновить существующие документы:
    ...
    - `docs/Instruments/BASS.md` — добавить секцию про Electric Bass
    - `docs/Instruments/DRUMS.md` — добавить секцию про Modern Kit
    - `docs/Instruments/PIANO.md` — добавить секцию про montuno-паттерн и стиле-специфичные voicing'и
    - `docs/Instruments/RHODES.md` — обновить стиле-специфичные режимы
    - `docs/ARCHITECTURE_BASE.md` — обновить секцию про инструменты (с 6 до 15+), добавить StyleProfile
  - Создать новые документы:
    - `docs/TRUMPET.md`, `docs/Instruments/VIBRAPHONE.md`, `docs/FLUTE.md`, `docs/Instruments/ORGAN.md`, `docs/Instruments/GUITAR.md`, `docs/Instruments/PERCUSSION.md`, `docs/Instruments/CLARINET.md`
...
_План создан на основе `docs/ARCHIVE/ARANGEMENT_VISION.md`. Статус обновлён 2026-07-01: фундамент и все инструменты готовы (18 из 29 задач ✅), UI и документация запланированы._
