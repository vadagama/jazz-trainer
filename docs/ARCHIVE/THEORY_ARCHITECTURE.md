...
> **Продуктовое видение:** `docs/ARCHIVE/THEORY_VISION.md` — что строим и зачем.
>
...
Существующие theory-плагины (заглушки) расширяются согласно `docs/ARCHIVE/SCALES-VISION.md`:

- **theory-scales:** Карточки ладов, детальный вид, панель практики → `docs/ARCHIVE/SCALES-VISION.md`
...
_Документ подготовлен на основе `docs/ARCHIVE/THEORY_VISION.md` от 2026-06-17. Первый драфт архитектуры — 2026-06-18. Требует ревью и синхронизации с `ARCHITECTURE_BASE.md` (добавить ADR-T01–T06)._
