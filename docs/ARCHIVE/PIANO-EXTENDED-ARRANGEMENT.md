...
*Документ обновлён: 2026-07-24. Замещает `docs/PIANO-EXTENDED-ARRANGEMENT.md` (v1).*
*Связанные документы: `docs/Instruments/PIANO.md` (текущая реализация), `docs/Instruments/RHODES.md` (комплементарный слой), `docs/Instruments/DRUMS.md` (общий pattern-движок).*
